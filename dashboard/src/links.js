...
const links = [
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-meteor" style="color:mediumaquamarine"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Twitch",
        "url" : "https://www.twitch.tv/directory/following/live",
        "icon" : `<i class="fa-brands ${iconSize} fa-twitch" style="color:#a970ff"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "YouTube",
        "url" : "https://www.youtube.com",
        "icon" : `<i class="fa-brands ${iconSize} fa-youtube" style="color:red;"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Netflix",
        "url" : "https://www.netflix.com",
        "icon" : `<i class="fa-solid ${iconSize} fa-n" style="color:#e50914"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Disney+",
        "url" : "https://www.disneyplus.com/en-gb/home",
        "icon" : `<i class="fa-solid ${iconSize} fa-hat-wizard" style="color:steelblue"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Prime Video",
        "url" : "https://www.amazon.com/Amazon-Video/b/?ie=UTF8&node=2858778011&ref_=nav_cs_prime_video",
        "icon" : `<i class="fa-brands ${iconSize} fa-amazon" style="color:#00a8e1;"></i>`,
        "target" : "#video-list"
    },
    /*
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-box fa-rotate-180" style="color:#1968aa;"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "LazyGoat",
        "url" : "https://lazygoat.tv/collection/y2sk7-nrAgbzRVHhFZUsyMEpvJEd/",
        "icon" : `<i class="fa-solid ${iconSize} fa-table-cells-large" style="color:#FD5205;"></i>`,
        "target" : "#video-list"
    },
    */
    {
    ...
    },
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-envelope" style="color:#ea4335"></i>`,
        "target" : "#tools-list"
    },
    {
        "title" : "Drive",
        "url" : "https://drive.google.com/drive/my-drive",
        "icon" : `<i class="fa-brands ${iconSize} fa-google-drive" style="color:#fbbc04"></i>`,
        "target" : "#tools-list"
    },
    {
        "title" : "Reddit",
    ...
    },
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-font-awesome" style="color:#528dd7"></i>`,
        "target" : "#tools-list"
    },
    {
        "title" : "Timeguessr",
    ...
    // Audio
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-microphone-lines" style="color:lightslategray"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Classical",
        "url" : "https://theclassicalstation.org/listen/",
        "icon" : `<i class="fa-solid ${iconSize} fa-music" style="color:sandybrown"></i>`,
        "target" : "#video-list"
    },
    {
        "title" : "Work Music",
        "url" : "https://www.youtube.com/playlist?list=PLWx-JvCYWQuE1BfLAhIaVMCK4GrVYRotC",
        "icon" : `<i class="fa-brands ${iconSize} fa-youtube-square" style="color:#cb0e0e"></i>`,
        "target" : "#video-list"
    },
    // Projects
    {
    ...
    },
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-book-skull" style="color:cornflowerblue"></i>`,
        "target" : "#project-list"
    },
    /*
    {
        ...
        "icon" : `<i class="fa-solid ${iconSize} fa-syringe" style="color:#85aeb5"></i>`,
        "target" : "#project-list"
    },
    */
    {
